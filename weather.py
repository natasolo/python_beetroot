...
class YahooWeatherForecast:
    ...
    def get(self, city, country):
        if self.weather_cache.get((city,country)):
            return self.weather_cache[(city,country)]
        ...
        self.weather_cache[(city,country)] = forecast
        return forecast
...
def _main():
    ...
    for i in range(8):
        city_info = CityInfo(input('Enter city:\n').lower(), input('Enter country:\n').lower(), weather_forecast=weather_forecast)
